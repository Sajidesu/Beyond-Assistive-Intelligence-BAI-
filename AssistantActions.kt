...
class AssistantActions(private val context: Context) : TextToSpeech.OnInitListener {
    ...
    /** Here e input ni Jhon iyang part--before sa funsetAlarm()
     * Task 3 (Native "Hands"): Write the setAlarm(time, label) function using the native AlarmManager.
     * Sets a simple alarm using the native Android AlarmClock intent.
     *
     * @param time The time in HH:mm format (e.g., "08:30").
     * @param label A label/name for the alarm (e.g., "Wake up").
     */
